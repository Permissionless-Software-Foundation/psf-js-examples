...
└── applications
    ...
    │   ├── sell-slp
    │   │   ├── e2e-exchange
    │   │   │   ├── step1-generate-signal.js
    │   │   │   ├── step2-purchase-tx.js
    │   │   │   ├── step3-approve.js
    │   │   │   ├── package.json
    │   │   │   └── util.js
    │   │   ├── README.md
    ...
    │       │   └── package.json
    │       ├── combine
    │       │   ├── step1-combine-inputs.js
    │       │   ├── step3-sign-own-tx.js
    │       │   ├── step4-combine-all.js
    │       │   ├── package.json
    │       │   ├── step2-unsigned-tx.js
    │       │   └── util.js
    │       └── check-balances
    │           ├── check-balances.js
    │           └── package.json
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/low-level/not-working/OP_RETURN/op_return.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/low-level/not-working/OP_RETURN/package.json`:

```json
{
  "name": "op_return",
  "version": "1.0.0",
  "description": "Create a raw tx sending an op_return message",
  "main": "op_return.js",
  "scripts": {
    "test": "echo no tests yet",
    "start": "node op_return.js"
  },
  "repository": {
    "type": "git",
    "url": "git+https://github.com/Permissionless-Software-Foundation/bch-js-examples.git"
  },
  "keywords": [
    "bitbox",
    "example",
  ...
  "author": "Joey King <joey@bitcoin.com>",
  "license": "MIT",
  "bugs": {
    "url": "https://github.com/Permissionless-Software-Foundation/bch-js-examples/issues"
  },
  "homepage": "https://github.com/Permissionless-Software-Foundation/bch-js-examples/blob/master/README.md"
}

```

`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/low-level/utxo-address/get-utxos.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/low-level/utxo-address/package.json`:

```json
{
  "name": "get-utxos",
  "version": "1.0.0",
  "description": "Get UTXOs associated with an address",
  "main": "get-utxos.js",
  "scripts": {
    "test": "echo no tests yet",
    "start": "node get-utxos.js"
  },
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/low-level/address-details/address-details.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/low-level/address-details/package.json`:

```json
{
  "name": "address-details",
  "version": "1.0.0",
  "description": "Get details about an address",
  "main": "address-details.js",
  "scripts": {
    "test": "echo no tests yet",
    "start": "node address-details.js"
  },
  "author": "Chris Troutner <chris.troutner@gmail.com>",
  "license": "MIT"
}
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/low-level/op-return/read-op-return.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/low-level/op-return/README.md`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/low-level/op-return/package-lock.json`:
...
```json
{
  ...
  "dependencies": {
    ...
    "@chris.troutner/bch-js": {
      "version": "2.1.7",
      "resolved": "https://registry.npmjs.org/@chris.troutner/bch-js/-/bch-js-2.1.7.tgz",
      "integrity": "sha512-vHQ8mYGRrq9QjbvC3Ira/du+ccPD74wXfnhgfcdhNqT3m4O5C5As4sq7BPCsrxVaLsem6k6ZBn20FgdedHyLOA==",
      "requires": {
        "apidoc": "^0.17.7",
        "assert": "^2.0.0",
        "axios": "^0.19.0",
    ...
    "bip38": {
      ...
      "integrity": "sha512-HiABhYNhhRNAAeGmkt3LS2El6oonIftNkHq6uFxHCjaCIEbHr7I6RIBhKMQWw5AhGzIPpO5Mt7I8bFOfKqqh9w==",
      "requires": {
        "bigi": "^1.2.0",
    ...
    "yargs-parser": {
      ...
      "integrity": "sha512-H/v51UNZQPkUMIT5h5hiwg4QKIY1RPvoBV4XcjUbRM8Bk2oKqqyZ0DIEbTFZB0XjbtSPG8SAa/0DxCQmiRgzKg==",
      "requires": {
        "camelcase": "^5.0.0",
        "decamelize": "^1.2.0"
      }
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/low-level/op-return/write-op-return.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/low-level/op-return/package.json`:

```json
{
  "name": "op-return-test",
  "version": "1.0.0",
  "description": "Simple example reading and writing OP_RETURN statements using bch-js",
  "main": "read-op-return.js",
  "scripts": {
    "test": "echo \"Error: no test specified\" && exit 1",
    "start": "node read-op-return.js"
  },
  "author": "Chris Troutner <chris.troutner@gmail.com>",
  "license": "MIT"
}
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/minimal-slp-wallet/sweep-wallet/sweep-wallet.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/minimal-slp-wallet/sweep-wallet/package.json`:

```json
{
  "name": "sweep-wallet",
  "version": "1.0.0",
  "description": "Scan addresses controlled by a 12-word mnemonic, and sweep the funds into the first address controlled by that wallet.",
  "main": "sweep-wallet.js",
  "scripts": {
    "test": "echo no tests yet",
    "start": "node sweep-wallet.js"
  },
  "author": "Chris Troutner <chris.troutner@gmail.com>",
  "license": "MIT"
}
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/minimal-slp-wallet/README.md`:

```md
# minimal-slp-wallet Examples
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/minimal-slp-wallet/create-wallet/create-wallet.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/minimal-slp-wallet/create-wallet/package.json`:

```json
{
  "name": "create-wallet",
  "version": "1.0.0",
  "description": "Create a new wallet using minimal-slp-wallet",
  "main": "create-wallet.js",
  "scripts": {
    "test": "echo no tests yet",
    "start": "node create-wallet.js"
  },
  "author": "Chris Troutner <chris.troutner@gmail.com>",
  "license": "MIT"
}
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/collaborate/README.md`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/collaborate/sell-slp/e2e-exchange/step1-generate-signal.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/collaborate/sell-slp/e2e-exchange/step2-purchase-tx.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/collaborate/sell-slp/e2e-exchange/step3-approve.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/collaborate/sell-slp/e2e-exchange/package.json`:

```json
{
  "name": "e2e-exchange",
  "version": "1.0.0",
  "description": "Exchange SLP tokens with collaborative txs",
  "main": "e2e-exchange.js",
  "scripts": {
    "test": "echo no tests yet",
    "start": "npm run step1",
    "step1": "node step1-generate-signal.js",
    "step2": "node step2-purchase-tx.js",
    "step3": "node step3-approve.js"
  },
  "repository": {
    "type": "git",
    "url": "git+https://github.com/Permissionless-Software-Foundation/bch-js-examples.git"
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/collaborate/sell-slp/e2e-exchange/util.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/collaborate/sell-slp/README.md`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/collaborate/sell-slp/create-wallets/create-wallets.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/collaborate/sell-slp/create-wallets/package.json`:

```json
{
  "name": "create-wallets",
  "version": "1.0.0",
  "description": "Create two collaborative tx wallets",
  "main": "create-wallets.js",
  "scripts": {
    "test": "echo no tests yet",
    "start": "node create-wallets.js"
  },
  "repository": {
    "type": "git",
    "url": "git+https://github.com/Permissionless-Software-Foundation/bch-js-examples.git"
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/collaborate/sell-slp/check-balances/check-balances.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/collaborate/sell-slp/check-balances/package.json`:

```json
{
  "name": "check-balances",
  "version": "1.0.0",
  "description": "Check the balances of the two collaborative tx wallets",
  "main": "check-balances.js",
  "scripts": {
    "test": "echo no tests yet",
    "start": "node check-balances.js"
  },
  "repository": {
    "type": "git",
    "url": "git+https://github.com/Permissionless-Software-Foundation/bch-js-examples.git"
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/collaborate/coinjoin/README.md`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/collaborate/coinjoin/create-wallets/create-wallets.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/collaborate/coinjoin/create-wallets/package.json`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/collaborate/coinjoin/combine/step1-combine-inputs.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/collaborate/coinjoin/combine/step3-sign-own-tx.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/collaborate/coinjoin/combine/step4-combine-all.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/collaborate/coinjoin/combine/package.json`:
...
```json
{
  ...
  "main": "token-starter.js",
  "scripts": {
    "test": "echo no tests yet",
    "start": "npm run step1",
    "step1": "node step1-combine-inputs.js",
    "step2": "node step2-unsigned-tx.js",
    "step3": "node step3-sign-own-tx.js",
    "step4": "node step4-combine-all.js"
  },
  "repository": {
    "type": "git",
    "url": "git+https://github.com/Permissionless-Software-Foundation/bch-js-examples.git"
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/collaborate/coinjoin/combine/step2-unsigned-tx.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/collaborate/coinjoin/combine/util.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/collaborate/coinjoin/check-balances/check-balances.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/collaborate/coinjoin/check-balances/package.json`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/wallet/sign-message/sign-message.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/wallet/sign-message/package.json`:

```json
{
  "name": "sign-message",
  "version": "1.0.0",
  "description": "Sign a message with the private key",
  "main": "send-wif.js",
  "scripts": {
    "test": "echo no tests yet",
    "start": "node sign-message.js"
  },
  "repository": {
    "type": "git",
    "url": "git+https://github.com/Permissionless-Software-Foundation/bch-js-examples.git"
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/wallet/consolidate-dust/package.json`:

```json
{
  "name": "consolidate-dust",
  "version": "1.0.0",
  "description": "Combine dust UTXOs",
  "main": "consolidate-dust.js",
  "scripts": {
    "test": "echo no tests yet",
    "start": "node consolidate-dust.js"
  },
  "author": "Chris Troutner <chris.troutner@gmail.com>",
  "license": "MIT"
}
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/wallet/consolidate-dust/consolidate-dust.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/wallet/consolidate-utxos/consolidate-utxos.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/wallet/consolidate-utxos/package.json`:

```json
{
  "name": "consolidate-utxos",
  "version": "1.0.0",
  "description": "Combine all UTXOs in an address into a single UTXO",
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/wallet/README.md`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/wallet/split-utxo/package.json`:

```json
{
  "name": "split-utxo",
  "version": "1.0.0",
  "description": "Split the largest UTXO into 5 smaller utxos",
  "main": "split-utxo.js",
  "scripts": {
    "test": "echo no tests yet",
    "start": "node split-utxo.js"
  },
  "author": "Chris Troutner <chris.troutner@gmail.com>",
  "license": "MIT"
}
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/wallet/split-utxo/split-utxo.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/wallet/send-WIF/send-wif.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/wallet/send-WIF/package.json`:

```json
{
  "name": "send-wif",
  "version": "1.0.0",
  "description": "Send some tBCH to another address using WIF as input.",
  "main": "send-wif.js",
  "scripts": {
    "test": "echo no tests yet",
    "start": "node send-wif.js"
  },
  "repository": {
    "type": "git",
    "url": "git+https://github.com/Permissionless-Software-Foundation/bch-js-examples.git"
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/wallet/list-utxos/list-utxos.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/wallet/list-utxos/package.json`:

```json
{
  "name": "list-utxos",
  "version": "1.0.0",
  "description": "List the UTXOs associated with the wallet address.",
  "main": "list-utxos.js",
  "scripts": {
    "test": "echo no tests yet",
    "start": "node list-utxos.js"
  },
  "repository": {
    "type": "git",
    "url": "git+https://github.com/Permissionless-Software-Foundation/bch-js-examples.git"
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/wallet/create-wallet/create-wallet.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/wallet/create-wallet/package.json`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/wallet/send-bch/send-bch.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/wallet/send-bch/package.json`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/wallet/check-balance/check-balance.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/wallet/check-balance/package.json`:

```json
{
  "name": "check-balance",
  "version": "1.0.0",
  "description": "Check the balance of an HDNode wallet",
  "main": "create-wallet.js",
  "scripts": {
    "test": "echo no tests yet",
    "start": "node check-balance.js"
  },
  "repository": {
    "type": "git",
    "url": "git+https://github.com/Permissionless-Software-Foundation/bch-js-examples.git"
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/wallet/send-all/send-all.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/wallet/send-all/package.json`:

```json
{
  "name": "send-all",
  "version": "1.0.0",
  "description": "Send all the BCH in an address to another address",
  "main": "send-all.js",
  "scripts": {
    "test": "echo no tests yet",
    "start": "node send-all.js"
  },
  "author": "Chris Troutner <chris.troutner@gmail.com>",
  "license": "MIT"
}
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/wallet/verify-signature/verify-signature.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/wallet/verify-signature/package.json`:
...
```json
{
  ...
  "scripts": {
    "test": "echo no tests yet",
    "start": "node verify-signature.js"
  },
  "repository": {
    "type": "git",
    "url": "git+https://github.com/Permissionless-Software-Foundation/bch-js-examples.git"
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/wallet/send-dust/send-dust.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/wallet/send-dust/package.json`:

```json
{
  "name": "send-dust",
  "version": "1.0.0",
  "description": "Send 'n' dust outputs to an address",
  "main": "send-dust.js",
  "scripts": {
    "test": "echo no tests yet",
    "start": "node send-dust.js"
  },
  "author": "Chris Troutner <chris.troutner@gmail.com>",
  "license": "MIT"
}
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/wallet/util.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/slp/burn-tokens/burn-tokens.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/slp/burn-tokens/package.json`:

```json
{
  "name": "burn-tokens",
  "version": "1.0.0",
  "description": "Burn a specific quantity of tokens",
  "main": "burn-tokens.js",
  "scripts": {
    "test": "echo no tests yet",
    "start": "node burn-tokens.js"
  },
  "author": "Chris Troutner <chris.troutner@gmail.com>",
  "contributors": [
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/slp/lookup-token/lookup-token.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/slp/lookup-token/package.json`:

```json
{
  "name": "lookup-token",
  "version": "1.0.0",
  "description": "Lookup token by id",
  "main": "lookup-token.js",
  "scripts": {
    "test": "echo no tests yet",
    "start": "node lookup-token.js"
  },
  "repository": {
    "type": "git",
    "url": "git+https://github.com/Permissionless-Software-Foundation/bch-js-examples/slp-sdk.git"
  },
  "keywords": [
    "slp-sdk",
    "example"
  ...
  "homepage": "https://github.com/Permissionless-Software-Foundation/bch-js-examples#readme"
}

```

`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/slp/README.md`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/slp/send-token/send-token.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/slp/send-token/package.json`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/slp/mint-token/package.json`:

```json
{
  "name": "mint-token",
  "version": "1.0.0",
  "description": "Mint additional SLP tokens",
  "main": "mint-token.js",
  "scripts": {
    "test": "echo no tests yet",
    "start": "node mint-token.js"
  },
  "repository": {
    "type": "git",
    "url": "git+https://github.com/Permissionless-Software-Foundation/bch-js-examples.git"
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/slp/mint-token/mint-token.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/slp/burn-all/burn-all.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/slp/burn-all/package.json`:

```json
{
  "name": "burn-all",
  "version": "1.0.0",
  "description": "Send all tokens and send entire balance of an address",
  "main": "burn-all.js",
  "scripts": {
    "test": "echo no tests yet",
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/slp/create-token/create-token.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/slp/create-token/package.json`:
...
```json
{
  ...
  "main": "create-token.js",
  "scripts": {
    "test": "echo no tests yet",
    "start": "node create-token.js"
  },
  "author": "Chris Troutner <chris.troutner@gmail.com>",
  "contributors": [
    "Gabriel Cardona <gabriel@bitcoin.com>"
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/slp/conversion/conversion.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/slp/conversion/package.json`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/slp/create-wallet/create-wallet.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/slp/create-wallet/package.json`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/slp/check-balances/check-balances.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/slp/check-balances/package.json`:

```json
{
  "name": "check-balances",
  "version": "1.0.0",
  "description": "Check balances for an address",
  "main": "check-balances.js",
  "scripts": {
    "test": "echo no tests yet",
    "start": "node check-balances.js"
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/slp/nft/send-nft/send-nft.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/slp/nft/send-nft/package.json`:

```json
{
  "name": "send-nft",
  "version": "1.0.0",
  "description": "Send SLP NFT (child) tokens to an address",
  "main": "send-nft.js",
  "scripts": {
    "test": "echo no tests yet",
    "start": "node send-nft.js"
  },
  "author": "Chris Troutner <chris.troutner@gmail.com>",
  "contributors": [
    "Gabriel Cardona <gabriel@bitcoin.com>",
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/slp/nft/send-group/send-group.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/slp/nft/send-group/package.json`:

```json
{
  "name": "send-group",
  "version": "1.0.0",
  "description": "Send SLP NFT Group tokens to an address",
  "main": "send-group.js",
  "scripts": {
    "test": "echo no tests yet",
    "start": "node send-group.js"
  },
  "author": "Chris Troutner <chris.troutner@gmail.com>",
  "contributors": [
    "Gabriel Cardona <gabriel@bitcoin.com>",
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/slp/nft/create-nft/create-nft.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/slp/nft/create-nft/package.json`:

```json
{
  "name": "create-nft",
  "version": "1.0.0",
  "description": "Create an NFT Token",
  "main": "create-nft.js",
  "scripts": {
    "test": "echo no tests yet",
    "start": "node create-nft.js"
  },
  "author": "Chris Troutner <chris.troutner@gmail.com>",
  "contributors": [
    "Gabriel Cardona <gabriel@bitcoin.com>"
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/slp/nft/parent-group/parent-group.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/slp/nft/parent-group/package.json`:

```json
{
  "name": "parent-group",
  "version": "1.0.0",
  "description": "Create a new Group Token",
  "main": "parent-group.js",
  "scripts": {
    "test": "echo no tests yet",
    "start": "node parent-group.js"
  },
  "author": "Chris Troutner <chris.troutner@gmail.com>",
  "license": "MIT"
}
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/slp/nft/README.md`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/slp/nft/create-group/create-group.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/slp/nft/create-group/package.json`:
...
```json
{
  ...
  "version": "1.0.0",
  "description": "Create a new Group Token",
  "main": "create-group.js",
  "scripts": {
    "test": "echo no tests yet",
    "start": "node create-group.js"
  },
  "author": "Chris Troutner <chris.troutner@gmail.com>",
  "contributors": [
    "Gabriel Cardona <gabriel@bitcoin.com>"
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/slp/nft/mint-group/package.json`:

```json
{
  "name": "mint-group",
  "version": "1.0.0",
  "description": "Mint new Group Tokens",
  "main": "mint-group.js",
  "scripts": {
    "test": "echo no tests yet",
    "start": "node mint-group.js"
  },
  "author": "Chris Troutner <chris.troutner@gmail.com>",
  "contributors": [
    "Gabriel Cardona <gabriel@bitcoin.com>"
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/slp/nft/mint-group/mint-group.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/bfp/write-bfp/write-bfp.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/bfp/write-bfp/package.json`:

```json
{
  "name": "write-bfp",
  "version": "1.0.0",
  "description": "Write some data to the chain using BFP",
  "main": "write-bfp.js",
  "scripts": {
    "test": "echo no tests yet",
    "start": "node write-bfp.js"
  },
  "author": "Chris Troutner <chris.troutner@gmail.com>",
  "license": "MIT"
}
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/bfp/README.md`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/bfp/read-bfp/read-bfp.js`:
...
`/home/trout/work/psf/code/psf-js-examples/bch-js/bch/applications/bfp/read-bfp/package.json`:

```json
{
  "name": "read-bfp",
  "version": "1.0.0",
  "description": "Read data off the chain that was written with the write-bfp example.",
  "main": "read-bfp.js",
  "scripts": {
    "test": "echo no tests yet",
    "start": "node read-bfp.js"
  },
  "author": "Chris Troutner <chris.troutner@gmail.com>",
  "license": "MIT"
}
